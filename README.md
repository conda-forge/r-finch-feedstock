...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5062&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-finch-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-finch` can be installed with `conda`:
...
```
mamba install r-finch
```

It is possible to list all of the versions of `r-finch` available on your platform with `conda`:
...
```
mamba search r-finch --channel conda-forge
```
...
mamba repoquery search r-finch --channel conda-forge

# List packages depending on `r-finch`:
mamba repoquery whoneeds r-finch --channel conda-forge

# List dependencies of `r-finch`:
mamba repoquery depends r-finch --channel conda-forge
```
